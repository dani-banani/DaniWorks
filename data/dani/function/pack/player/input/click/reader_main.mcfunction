...
execute as @p if entity @s[tag=dani.input.click.reader.mainhand] unless items entity @s weapon.mainhand *[minecraft:custom_data~{dani:clickApiStart}] run function dani:api/input/click/stop
execute as @p if entity @s[tag=dani.input.click.reader.offhand] unless items entity @s weapon.offhand *[minecraft:custom_data~{dani:clickApiStart}] run function dani:api/input/click/stop